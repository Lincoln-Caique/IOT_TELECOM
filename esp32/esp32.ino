...
#define timerDelay 10000 //Intervalo entre cada leitura do sensor

//SSID e senha da rede WiFi onde o esp32 irá se conectar 
#define SSID "Santos"
#define PASSWORD "****17**11**99"

//Objeto que realiza a leitura da umidade e temperatura
Adafruit_AHT10 aht;

const char* server = "http://192.168.0.102:3070/datalogger";
...
void loop()
{
  ...
  if(now - lastTimeRead > timerDelay)
  {
    ...
    if (WiFi.status() == WL_CONNECTED) {
            ...
            object["temperature"] = t; //Inserimos os atributo de temperatura
            object["humidity"] = h; //Inserimos os atributo de umidade
